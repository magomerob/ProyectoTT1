...
int test_varEqn()
{
	double x = 0.000373019245306087;
	Matrix yPhi(42);
	yPhi(1)=7098603.04178014;
	yPhi(2)=1310604.50403356;
	yPhi(3)=46416.3980983215;
	yPhi(4)=613.667192459812;
	yPhi(5)=-3077.71060365239;
	yPhi(6)=-6735.86863966224;
	yPhi(7)=1.00000000000014;
	yPhi(8)=3.95696294667072e-14;
	yPhi(9)=1.40672277535764e-15;
	yPhi(10)=7.53338701463358e-10;
	yPhi(11)=2.12158618710481e-10;
	yPhi(12)=7.5422922700984e-12;
	yPhi(13)=3.95696295472286e-14;
	yPhi(14)=0.999999999999933;
	yPhi(15)=2.59958936752755e-16;
	yPhi(16)=2.12158618842107e-10;
	yPhi(17)=-3.56602739813865e-10;
	yPhi(18)=1.39379701315144e-12;
	yPhi(19)=1.40672250239836e-15;
	yPhi(20)=2.59958818840663e-16;
	yPhi(21)=0.999999999999926;
	yPhi(22)=7.54229153069166e-12;
	yPhi(23)=1.39379661270864e-12;
	yPhi(24)=-3.96735960996625e-10;
	yPhi(25)=0.000373019245306105;
	yPhi(26)=4.92007468376078e-18;
	yPhi(27)=1.74909892733728e-19;
	yPhi(28)=1.00000000000014;
	yPhi(29)=3.95696183678191e-14;
	yPhi(30)=1.40669739500901e-15;
	yPhi(31)=4.92007467845137e-18;
	yPhi(32)=0.000373019245306079;
	yPhi(33)=3.23229168832862e-20;
	yPhi(34)=3.95696183077798e-14;
	yPhi(35)=0.999999999999933;
	yPhi(36)=2.59954172950226e-16;
	yPhi(37)=1.74909893673242e-19;
	yPhi(38)=3.232291041939e-20;
	yPhi(39)=0.000373019245306078;
	yPhi(40)=1.40669741366639e-15;
	yPhi(41)=2.59954156527496e-16;
	yPhi(42)=0.999999999999926;

	Matrix B = varEqn(x,transpose(yPhi));

	Matrix exp(42);
	exp(1)=613.667192459812;
	exp(2)=-3077.71060365239;
	exp(3)=-6735.86863966224;
	exp(4)=-7.53151922994076;
	exp(5)=-1.39056794048225;
	exp(6)=-0.04937566141733;
	exp(7)=7.5333870146e-10;
	exp(8)=2.1215861871e-10;
	exp(9)=7.54229227e-12;
	exp(10)=2.01957069645461e-06;
	exp(11)=5.68760276209488e-07;
	exp(12)=2.02190322123889e-08;
	exp(13)=2.1215861884e-10;
	exp(14)=-3.5660273981e-10;
	exp(15)=1.39379701e-12;
	exp(16)=5.68760276209488e-07;
	exp(17)=-9.55990284268096e-07;
	exp(18)=3.73642571049909e-09;
	exp(19)=7.54229153e-12;
	exp(20)=1.39379661e-12;
	exp(21)=-3.96735961e-10;
	exp(22)=2.02190335585343e-08;
	exp(23)=3.73642716766681e-09;
	exp(24)=-1.06358041471181e-06;
	exp(25)=1.00000000000014;
	exp(26)=3.956962e-14;
	exp(27)=1.4067e-15;
	exp(28)=7.53338737033714e-10;
	exp(29)=2.12158528991735e-10;
	exp(30)=7.54208813668442e-12;
	exp(31)=3.956962e-14;
	exp(32)=0.999999999999933;
	exp(33)=2.5995e-16;
	exp(34)=2.12158528991734e-10;
	exp(35)=-3.56602774357658e-10;
	exp(36)=1.39375869867257e-12;
	exp(37)=1.4067e-15;
	exp(38)=2.5995e-16;
	exp(39)=0.999999999999926;
	exp(40)=7.54208863882254e-12;
	exp(41)=1.39375924222417e-12;
	exp(42)=-3.96735963618153e-10;

	_assert(m_equals(transpose(B),exp,1e-8));
	return 0;
}
...
int test_accel()
{
	...
	_assert(m_equals(acc,transpose(exp), 1e-4));
